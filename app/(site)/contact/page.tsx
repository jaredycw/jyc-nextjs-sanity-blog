                ...
                <div>
                    <div className="mb-5">
                       ...
                       <p>Feel free to contact me 🔥</p>
                        ...
                        <p>Need a stunning, mobile-friendly website or blog? Lets try <Link href="https://www.strikingly.com/a/NaRgIB" target="_blank" className="ugly-blue">Strikingly</Link>, a user-friendly platform, less code, no code!</p>
                    </div>
                    <div className="mb-10">
