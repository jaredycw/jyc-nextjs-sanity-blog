                ...
                <div>
                    <div className="mb-5">
                       ...
                       <p>Feel free to contact me 🔥</p>
                        ...
                        <p>Need a stunning, mobile-friendly website or blog? Lets try <Link href="https://www.strikingly.com/a/NaRgIB" target="_blank" className="ugly-blue">Strikingly</Link>, a user-friendly platform that lets anyone—coding skills or not—build sleek, optimized sites for all devices, from phones to desktops. Get in touch, and let’s create something amazing together!</p>
                    </div>
                    <div className="mb-10">
