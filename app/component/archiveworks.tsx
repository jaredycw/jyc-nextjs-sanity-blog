...
export default function ArchiveWorks({ works }: any) {
      ...
      const [ catNum, setCatNum] = useState(9); // Default number of posts dislplayed

      function handleClick() {
        setCatNum(prevCatNum => prevCatNum + 9) // 6 is the number of posts you want to load per click
      }
